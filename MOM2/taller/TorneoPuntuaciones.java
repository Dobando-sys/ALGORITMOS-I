...
public class TorneoPuntuaciones {
    ...
    teclado.close(); //ERROR DE SINTAXIS CORREGIDO : Se debe cerrar el Scanner para liberar recursos.
    ...
    //EERROR DE SINTAXIS CORREGIDO : Se debe usar (puntuaciones.length-1) en lugar de puntuaciones.length. Esto porque el índice del vector va de 0 a 4, y el tamaño del vector es 5.
