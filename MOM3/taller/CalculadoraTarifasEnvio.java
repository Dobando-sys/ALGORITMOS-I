...
public class CalculadoraTarifasEnvio {
    ...
    public static double calcularCostoAdicionalPorPeso(double pesoKg, int zona) {
        ...
        switch (zona) {
            case 1: // Local
                // Tu código aquí
                return pesoKg*=COSTO_ADICIONAL_POR_KG_LOCAL;

            case 2: // Nacional
                // Tu código aquí
                return pesoKg*=COSTO_ADICIONAL_POR_KG_NACIONAL;

            case 3: // Internacional
                // Tu código aquí
                return pesoKg*=COSTO_ADICIONAL_POR_KG_INTERNACIONAL;
     ...
     * clone@param zona El tipo de zona: 1 para Local, 2 para Nacional, 3 para
     * Internacional.
     * 
    ...
    public static double obtenerCostoBasePorZona(int zona) {
        ...
        switch (zona) {
            case 1:
                return COSTO_BASE_LOCAL;
            case 2:
                return COSTO_BASE_NACIONAL;
            
            case 3:
                return COSTO_BASE_INTERNACIONAL;
            default:
                System.out.println("Advertencia: Zona no válida.");
                break;
        }
    ...
    public static void main(String[] args) {
        ...
        // Debe ser un número positivo. Usa un bucle do-while hasta que se ingrese un
        // valor válido.
